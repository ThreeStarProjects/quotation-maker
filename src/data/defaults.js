...
export const calcTotals = (items, charges, gst, gstType = 'intra') => {
  ...
  if (gst) {
    if (gstType === 'inter') { igst = taxable * 0.18 }
    else { cgst = taxable * 0.09; sgst = taxable * 0.09 }
  }
...
export const DEFAULT_ANNEX_IMG_SIZE = 150   // pt — image size in annex
export const DEFAULT_ANNEX_IMG_COLS = 3     // images per row in annex
